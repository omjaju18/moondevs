...
import { BurnStatsProps } from './types'; // Import any necessary types

interface BurnStatsContainerProps extends BurnStatsProps {
  numberWithCommas: (value: number) => string;
  AppIcon: React.ComponentType<any>;
  AppChip: React.ComponentType<any>;
  AppExtLink: React.ComponentType<any>;
  IconFilter: any; 
  chainTokenSymbols: Map<any, any>; 
}


const BurnStatsContainer: React.FC<BurnStatsProps> = ({
  suppliesChain,
  statsSupplies,
  allSupplies,
  openChainModal,
